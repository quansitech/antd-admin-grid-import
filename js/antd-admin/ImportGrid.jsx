...
class ImportGrid extends React.Component {
    ...
    render() {
        ...
        if (this.state.data) {
            return (<div>
                <Space>
                    <SubmitButton async={this.props.async} asyncProcessNotify={this.props.asyncProcessNotify}
                                  data={this.state.data} submiturl={this.props.submitUrl} success={this.importSuccess}
                                  update={this.updateState} showerr={this.error} style={{marginBottom: "5px"}}/>
                    <ExportErrBtn
                        style={{marginBottom: "5px", marginLeft: "-335px"}}
                        data={this.state.data}
                        hasDataError={this.state.hasDataError}
                        exportErrObj={{
                            ...this.props.exportErrObj,
                ...
                <BaseTable ref={this.tableRef} columns={this.state.data.columns} row_data={this.state.data.row_data}
